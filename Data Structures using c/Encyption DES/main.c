...
FILE* out;
int LEFT[17][32], RIGHT[17][32],IPtext[64],EXPtext[48],XORtext[48],X[8][6],X2[32],R[32];
int key56bit[56],key48bit[17][48],CIPHER[64],ENCRYPTED[64];
unsigned int key[64],bits[4000],keys[4000];
...
void HexToBin(char* hexdec)
{
    ...
    while (hexdec[i]) {
        ...
        switch (hexdec[i]) {
        case '0':
            keys[j++]=0;keys[j++]=0;keys[j++]=0;keys[j++]=0;
            break;
        case '1':
            keys[j++]=0;keys[j++]=0;keys[j++]=0;keys[j++]=1;
            break;
        case '2':
            keys[j++]=0;keys[j++]=0;keys[j++]=1;keys[j++]=0;
            break;
        case '3':
            keys[j++]=0;keys[j++]=0;keys[j++]=1;keys[j++]=1;
            break;
        case '4':
            keys[j++]=0;keys[j++]=1;keys[j++]=0;keys[j++]=0;
            break;
        case '5':
            keys[j++]=0;keys[j++]=1;keys[j++]=0;keys[j++]=1;
            break;
        case '6':
            keys[j++]=0;keys[j++]=1;keys[j++]=1;keys[j++]=0;
            break;
        case '7':
            keys[j++]=0;keys[j++]=1;keys[j++]=1;keys[j++]=1;
            break;
        case '8':
            keys[j++]=1;keys[j++]=0;keys[j++]=0;keys[j++]=0;
            break;
        case '9':
            keys[j++]=1;keys[j++]=0;keys[j++]=0;keys[j++]=1;
            break;
        case 'A':
        case 'a':
            keys[j++]=1;keys[j++]=0;keys[j++]=1;keys[j++]=0;
            break;
        case 'B':
        case 'b':
            keys[j++]=1;keys[j++]=0;keys[j++]=1;keys[j++]=1;
            break;
        case 'C':
        case 'c':
            keys[j++]=1;keys[j++]=1;keys[j++]=0;keys[j++]=0;
            break;
        case 'D':
        case 'd':
            keys[j++]=1;keys[j++]=1;keys[j++]=0;keys[j++]=1;
            break;
        case 'E':
        case 'e':
            keys[j++]=1;keys[j++]=1;keys[j++]=1;keys[j++]=0;
            break;
        case 'F':
        case 'f':
            keys[j++]=1;keys[j++]=1;keys[j++]=1;keys[j++]=1;
            break;
        default:
...
{
    char str[16];
    printf("Enter Key to Encrypt Your Plaintext: ");
    scanf("%s",str);
    HexToBin(str);
    int i =0;
    while (i<64)
...
{  // destroy contents of these files (from previous runs, if any)
    ...
    fclose(out);
    create16Keys();
    printf("\nEnter your Plaintext in Hexadecimal Format: ");
    char plaintext[1000];
    scanf("%s",plaintext);
